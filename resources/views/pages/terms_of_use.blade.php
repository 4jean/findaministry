...
@section('bc', Breadcrumbs::render('terms_of_use'))
        ...
        <div class="row">
            ...
            <div class="col-md-9 col-sm-9">
                ...
                <section>
                    <div class="row">
                        <div class="col-md-12">
                            <div class="panel panel-body border-bottom-success-700" style="color: #000; font-size: 16px;">
                                <p>These terms and conditions outline the rules and regulations for the use of Find A Ministry's Website.<span style="text-transform: capitalize;"> Find A Ministry</span> is located at:</p>
                                <address>Global Word of Restoration Ministries , Karu<br />Abuja - 900008, Nigeria</address>
                                <p>By accessing this website we assume you accept these terms and conditions in full. Do not continue to use Find A Ministry's website if you do not accept all of the terms and conditions stated on this page.</p>
                                ...
                                <h2>Removal of Ministries&nbsp;&amp; links from our website</h2>
