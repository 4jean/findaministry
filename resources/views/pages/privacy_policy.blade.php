...
@section('bc', Breadcrumbs::render('privacy_policy'))
        ...
        <div class="row">
            ...
            <div class="col-md-9 col-sm-9">
                ...
                <section>
                    <div class="row">
                        <div class="col-md-12">
                            <div class="panel panel-body border-top-brown-700 border-bottom-brown-700">
                                <p>This Privacy Policy governs the manner in which Find A Ministry collects, uses, maintains and discloses information collected from users of the <a href="{{ url('/') }}">{{ url('/') }}</a> website ("Site").</p>
                                ...
                                <p>Find A Ministry may collect and use Users personal information for the following purposes:</p>
                                ...
                                <p>Find A Ministry has the discretion to update this privacy policy at any time. When we do, we will post a notification on the main page of our Site. We encourage Users to frequently check this page for any changes to stay informed about how we are helping to protect the personal information we collect. You acknowledge and agree that it is your responsibility to review this privacy policy periodically and become aware of modifications.</p>
                                <h3>Your acceptance of these terms</h3>
                                <p>By using this Site, you signify your acceptance of this policy. If you do not agree to this policy, please do not use our Site. Your continued use of the Site following the posting of changes to this policy will be deemed your acceptance of those changes. This privacy policy was built&nbsp;<a href="https://privacypolicies.com/" target="_blank" rel="noopener">with a free policy generator</a>.</p>
                                <h3>Contacting us</h3>
                                <p>If you have any questions about this Privacy Policy, the practices of this site, or your dealings with this site, please contact us.</p>
                                <p>This document was last updated on March 15, 2018</p>
