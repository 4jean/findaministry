...
{{--<script type="text/javascript" src="{{ asset('assets/js/selects/bootstrap-select.min.js') }}"></script>--}}
<script  src="https://cdnjs.cloudflare.com/ajax/libs/bootstrap-select/1.5.4/bootstrap-select.min.js"></script>

{{--<script type="text/javascript" src="{{ asset('assets/js/tables/datatables.min.js') }}"></script>--}}
...
<script src="http://cdnjs.cloudflare.com/ajax/libs/summernote/0.8.9/summernote.min.js"></script>
...
<script  type="text/javascript" src="{{ asset('assets/js/plugins/typeahead.min.js') }}"></script>
